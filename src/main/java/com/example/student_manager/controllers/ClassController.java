...
public class ClassController {
    ...
    @PostMapping
    public ResponseEntity<ResponseDetail<ClassDTO>> create(@RequestBody ClassIn classIn) {
        return service.create(classIn);
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<ResponseDetail<ClassDTO>> delete(@PathVariable("id") int id) {
        return service.delete(id);
    }

    @PutMapping("/{id}")
    public ResponseEntity<ResponseDetail<ClassDTO>> edit(@RequestBody ClassIn classIn, @PathVariable("id") int id) {
